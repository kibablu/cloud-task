...
# -----------------------------------------------------------------------------
# Firewall Rule (Allow 22, 80, 443 Ingress)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Service Account and IAM Roles (Cloud SQL & Cloud Storage & Secret Manager)
# -----------------------------------------------------------------------------
...
# IAM Role Cloud SQL Client (allows connections/reads/writes to the database via Proxy)
...
# IAM Role Storage Object Admin (allows read/write/delete objects in storage)
...
# IAM Role Secret Manager Accessor (allows VM to retrieve database credentials)
...
# -----------------------------------------------------------------------------
# Cloud Storage Bucket (Publicly available)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# HA Cloud SQL Instance (Sandbox Tier, Private IP Only)
# -----------------------------------------------------------------------------
...
# Create Private Service Access Connection (VPC Peering)
...
# Highly Available Cloud SQL Instance (MySQL, Sandbox tier/db-f1-micro, private IP)
...
# Create the Database User using the Secret Manager password
...
# -----------------------------------------------------------------------------
# Compute Engine Instance (CentOS, Public IP, attached SA)
# -----------------------------------------------------------------------------
